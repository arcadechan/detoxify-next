        ...
        <section className='py-10'>
          ...
          <ul className='credits-list'>
            ...
            <li>
              Vue.js
              <ul>
                <li><a href="https://codepen.io/numerical/pen/yKMaaP" target='_blank'>Vue.js + HTML 5 Audio Player</a> by Cameron at CodePen</li>
              </ul>
            </li>
            <li>
              Spotify API
            ...
            <li>
              Bootstrap
              <ul>
                <li><a href="https://sharebootstrap.com/art-studio-minimal-studio-template/" target='_blank'>Art Studio Minimal Portfolio Theme</a> by ShareBootstrap</li>
              </ul>
            </li>
            <li>Hamburger menu icon made by <a href="https://www.flaticon.com/authors/hirschwolf" target='_blank'>hirschwolf</a> from <a href="https://www.flaticon.com/" target='_blank'>www.flaticon.com</a></li>
            <li>Potion icon made by <a href="https://www.flaticon.com/authors/freepik" target='_blank'>Freepik</a> from <a href="https://www.flaticon.com/" target='_blank'>www.flaticon.com</a></li>
            <li><a href="https://www.pexels.com/photo/high-voltage-power-lines-against-mountains-in-sunset-4555345/" target='_blank'>Playlist cover image</a> by <a href="https://www.pexels.com/@roman-odintsov" target='_blank'></a> from <a href="https://www.pexels.com/" target='_blank'>Pexels</a></li>
          </ul>
          <br />
          <p>The repo for the original application can be <a href="https://github.com/arcadechan/detoxify" target='_blank'>found here.</a></p>
        </section>
        <hr className='my-5'/>
